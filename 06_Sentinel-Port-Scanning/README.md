...
We also see that the source IP was internal: 10.0.1.50, which we know from the in-depth investigation in part 4, that this was Mirage's compromised machine running an internal scan of the network. 
